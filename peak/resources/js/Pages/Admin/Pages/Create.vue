...
const author = usePage().props.auth?.user;
...
<template>
  <AdminLayout :description="__('New Page')" :page-icon="false" :title="__('New Page')">
            ...
            <div class="space-y-3 sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                <Input id="title" v-model="form.title" class="w-full"
                       placeholder="keyword-rich title" @input="generateSlug"/>
            ...
            <div class="space-y-3">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                                <TextArea id="meta_description" v-model="form.meta_description" class="!w-full"
                                          placeholder="Summarizing the blog post" rows="3"/>
        ...
        <Card :has-error="form.errors?.length > 0">
          ...
          <div class="flex flex-col space-y-6">
            ...
            <div class="space-y-3 sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                <Input id="published_at" v-model="form.published_at" class="w-full" type="date"/>
