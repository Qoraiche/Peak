...
const form = useForm({
  ...
  author: props.doc.user.id,
  slug: props.doc.title,
  label: props.doc.label,
  excerpt: props.doc.excerpt,
  published_at: props.doc.published_at,
  body: props.doc.body,
  headings: props.doc.headings
});

const categories = ref(props.categories);
const docsByCategory = ref(props.docsByCategory);
...
const submit = () => {
  ...
  form.put(route('admin.docs.update', props.doc.id), {
    onSuccess: () => {
      toast.success(__('Doc saved'));
    },
  });
};
...
<template>
  <AdminLayout :description="__('Edit :resourcename #:id', {resourcename: 'Doc', id: doc.id})"
               :title="__('Edit Documentation')">
          ...
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-2 space-y-3">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                <Input id="label" v-model="form.label" class="w-full"
                       @input="generateSlug"/>
            ...
            <div class="sm:col-span-2 space-y-3">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                <TextArea id="description" v-model="form.excerpt" class="w-full" rows="3"/>
          ...
          <div class="flex flex-col space-y-6">
            ...
            <div class="sm:col-span-1 space-y-3">
              ...
              <dd class="mt-1 text-sm text-gray-900 break-words">
                <a :href="doc.url" class="text-blue-600" target="_blank">{{ doc.url }}</a>
              </dd>
            </div>
          </div>
        </Card>
          ...
          <div class="flex flex-col space-y-6">
            <div>
              ...
              <div class="mt-2 flex flex-col space-y-2">
                <SelectUser :limit="20" :pre-selected-user="doc.user" :roles="$page.props.config.admin_roles"
