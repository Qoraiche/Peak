    ...
    <template #content>
      ...
      <div v-if="sessions.length > 0" class="mt-5 space-y-6">
        <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
          <div>
            <svg v-if="session.agent.is_desktop" class="size-8 text-gray-500" fill="none"
            ...
            <svg v-else class="size-8 text-gray-500" fill="none" stroke="currentColor" stroke-width="1.5"
