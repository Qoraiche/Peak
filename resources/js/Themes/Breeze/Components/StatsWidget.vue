...
<template>
  <section :class="{'border' : bordered}" class="rounded-xl bg-zinc-50 dark:bg-gray-900 w-full">
    <div class="p-6">
                ...
                <template #fallback>
                  <div class="space-y-2 w-full">
                    <div v-for="n in 2"
                      ...
                      <div class="w-full">
                        <div
                            class="h-2.5 bg-zinc-200/80 rounded-full dark:bg-zinc-700 w-24"></div>
                      </div>
      ...
      <div v-if="$slots.label" class="mt-2 text-sm font-medium text-gray-500 truncate">
        <slot name="label"/>
      </div>
    </div>
  </section>
