@php use Qoraiche\Peak\Helpers; $theme = current_theme_name(); @endphp
        <!DOCTYPE html>
<html dir="ltr" class="scroll-smooth"
      lang="{{ str_replace('_', '-', Helpers::getLocale()) }}">
<head>
    <meta charset="utf-8">
    ...
    @vite([
        "resources/js/Themes/{$theme}/theme.js",
        "resources/js/Themes/{$theme}/Pages/{$page['component']}.vue"
    ])
